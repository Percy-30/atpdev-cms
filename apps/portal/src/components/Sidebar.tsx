      ...
      >
        ...
        <div className="flex flex-col items-center justify-center p-8 mt-4">
          <div className="w-32 h-32 rounded-full bg-gray-700 border-4 border-gray-600 mb-4 overflow-hidden">
            ...
            <img 
              ...
              onError={(e) => {
                ...
                target.src = "https://ui-avatars.com/api/?name=ATP+DEV&background=0D8ABC&color=fff&size=128";
              }}
            />
          </div>
          ...
          <div className="flex space-x-3">
            <a href="#" className="p-2 bg-[#212431] rounded-full hover:bg-blue-500 transition-colors">
              <Globe size={18} />
            </a>
            <a href="#" className="p-2 bg-[#212431] rounded-full hover:bg-blue-500 transition-colors">
              <Users size={18} />
